...
public class TemplatesActivity extends AppCompatActivity {
    ...
    private void loadTemplates() {
        ...
        templateList.add(new Template(
            "Dev Portfolio",
            "A clean portfolio template to showcase developer projects.",
